  ...
  <div class="row">
    ...
    <div class="col s12 m10 l10" style="height: 550px; overflow: auto;">
      ...
      <?php  
        ...
        $id = $_GET['id'];
        $sel = $pdo->prepare("SELECT * FROM client WHERE id = ?");
        $sel->bindParam(1, $id);
        $sel->execute();
      ...
      ?>
        ...
        <table class="table table-sm" style="width: 100%;border-left:5px solid #000088;border-right:5px solid #000088;border-top:2px solid #ddd;border-bottom:2px solid #ddd;">

                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      REFERER <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      OTHER PHONE/CELLULAR <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      BUSINESS ADDRESS <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      WHO ARE YOU? <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      SELLER'S PROPERTY DOCUMENT <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      PROPERTY ADDRESS <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      INVESTOR AIM & OBJECTIVES <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      BUYERS SPEC & BUDGET <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      YES AND SIGNATURE <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      NO AND REASON <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      MEETING TIME <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      MEETING DATE <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
                ...
                <tr>
                  <td style="font-size:15px">
                    <p style="font-family: candara; font-weight:bold;color:#0d47a1 ">
                      SUBMITTED ON <i class="fas fa-angle-right"></i>
                    </p>
                  </td>
