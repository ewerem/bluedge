...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col s12 m10 l10" style="height: 550px; overflow: auto;">
			...
			?>
				<a href="co-info.php?id=<?=$f['id']?>" title="click to view more details">
                ...
                <tr>
                  <td style="font-size:14px">
                    <p style="font-family: lucida sans; font-weight:bold;color:#000">
                      ...
                      <br>
                      <a href="cdel.php?id=<?=$f['id']?>&name=<?=$f['fname']?>" style="float:right;margin-top: -25px;padding: 5px; color: white;background: red;">X
                      </a>
                    </p>
                  </td>
                </tr>
